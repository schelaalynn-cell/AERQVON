  ...
  return (
    <div className="min-h-screen pb-24">
      ...
      <div className="mx-auto max-w-md px-4 pt-4 space-y-6">
        ...
        <div>
          <h2 className="mb-2 text-xs font-semibold uppercase tracking-wide text-nova-dim">
            AERQVON Launch
          </h2>
            ...
            <div className="border-b border-nova-border p-4">
              <div className="mb-3 flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm font-semibold">AERQVON (AQV)</p>
                  <p className="text-xs text-nova-muted">Solana · Pump.fun</p>
                </div>
                ...
                <span
                  className={`rounded-full px-2 py-0.5 text-[10px] font-semibold ${
                    aqvLaunched
                      ...
                      : 'bg-nova-warning/15 text-nova-warning'
                  }`}
                >
                  {aqvLaunched ? 'LIVE' : 'PRE-LAUNCH'}
                </span>
              </div>

              {aqvLaunched ? (
                <div className="space-y-3">
                  <div className="rounded-xl bg-nova-surface-2 px-3 py-2.5">
                    <p className="text-[10px] uppercase tracking-wide text-nova-dim">
                    ...
                    <div className="mt-1 flex items-center justify-between gap-2">
                      ...
                      <button
                        onClick={() => {
                          navigator.clipboard?.writeText(aqvMintAddress);
                          setMintCopied(true);
                          haptic('light');
                      ...
                      >
                        {mintCopied ? (
                          <Check className="h-3.5 w-3.5 text-nova-success" />
                        ) : (
                    ...
                    <a
                      href={`https://pump.fun/coin/${aqvMintAddress}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl bg-nova-accent py-2.5 text-sm font-semibold text-white transition-colors hover:bg-nova-accent-2"
                    >
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-2 rounded-xl bg-nova-warning/10 px-3 py-2.5">
                    <CircleCheck className="mt-0.5 h-4 w-4 shrink-0 text-nova-warning" />
                    <p className="text-[11px] leading-relaxed text-nova-muted">
                      AERQVON has not launched yet. The official Solana mint
                      address will be added here once the token is created on
                      Pump.fun. Do not trust any AQV token address from third
                      parties.
                    </p>
                  </div>

                  <div className="flex items-center justify-center gap-2 rounded-xl bg-nova-surface-2 py-2.5 text-sm font-medium text-nova-dim">
                    <Rocket className="h-4 w-4 text-nova-warning" />
                    Launch CTA available after launch
                  </div>
                </div>
              )}
            </div>
